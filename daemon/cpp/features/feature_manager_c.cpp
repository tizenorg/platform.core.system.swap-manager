...
static uint64_t checkSupportFeatures(uint64_t setFeatures,
                                     uint64_t supportedFeatures, size_t offset)
{
    uint64_t unsupportedFeatures = setFeatures & (~supportedFeatures);
    ...
    return setFeatures & supportedFeatures;
}
