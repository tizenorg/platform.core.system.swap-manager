...
enum feature_code{
	...
	FL_RESERVED3			= 0x00000FF00000ULL, // reserved
	...
	FL_RESERVED4			= 0x000400000000ULL, // reserved
	FL_RESERVED5			= 0x000800000000ULL, // reserved
	...
	FL_SYSTEM_DISK			= 0x040000000000ULL, // /proc/diskstats - reads, sectors read, writes, sectors written
	FL_SYSTEM_NETWORK		= 0x080000000000ULL, // network send/recv size
	FL_SYSTEM_DEVICE		= 0x100000000000ULL, //
	FL_SYSTEM_ENERGY		= 0x200000000000ULL, //

	FL_RESERVED6			= 0x400000000000ULL, // reserved
	FL_RESERVED7			= 0x800000000000ULL, // reserved
