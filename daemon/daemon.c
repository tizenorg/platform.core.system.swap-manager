...
static int launch_timer_cb(int fd, void *data)
{
...
static int connect_timer_cb(int fd, void *data)
{
...
static bool launch_timer_start(void)
{
	...
	if (!evloop_add_event(fd, NULL, connect_timer_cb)) {
...
static int target_event_cb(int fd, void *data)
{
	uint64_t u;
	ssize_t recvLen;
...
static int host_data_cb(int fd, void *data)
{
	ssize_t recvLen;
	char recvBuf[32];
...
static int host_connect_cb(int fd, void *data)
{
...
static int target_connect_cb(int fd, void *data)
{
