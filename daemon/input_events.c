...
static struct nevent *key_handlers[MAX_DEVICE];
static struct nevent *touch_handlers[MAX_DEVICE];
...
static int touch_event_cb(int fd, void *data)
{
...
static int key_event_cb(int fd, void *data)
{
