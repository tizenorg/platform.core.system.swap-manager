...
{
	ui_viewer_log("object : 0x%lx, category : %d, type_code: %d, "
			"type_name : %s, redraw : %d, "
			"parent : 0x%lx\n",
...
static char *pack_ui_obj_evas_prop(char *to, ui_obj_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_ui_obj_elm_prop(char *to, ui_obj_elm_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_ui_obj_edje_prop(char *to, ui_obj_edje_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_image_prop(char *to, image_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_line_prop(char *to, line_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_text_prop(char *to, text_prop_t *prop)
{
	int i = 0, fonts_count = 0;

	if (!prop)
		return to;

	to = pack_string(to, prop->fonts[0]);
	fonts_count = sizeof(prop->fonts) / sizeof(prop->fonts[0]);
	for (i = 1; i < fonts_count; i++) {
		to = pack_string(to, ",");
		to = pack_string(to, prop->fonts[i]);
	}
...
static char *pack_textblock_prop(char *to, textblock_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_table_prop(char *to, table_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_box_prop(char *to, box_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_grid_prop(char *to, grid_prop_t *prop)
{
	if (!prop)
		return to;

	to = pack_int8(to, prop->mirrored);
	to = pack_int32(to, prop->pack[0]);
	to = pack_int32(to, prop->pack[1]);
	to = pack_int32(to, prop->pack[2]);
	to = pack_int32(to, prop->pack[3]);

	return to;
}

static char *pack_textgrid_prop(char *to, textgrid_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_bg_prop(char *to, bg_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_button_prop(char *to, button_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_check_prop(char *to, check_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_colorselector_prop(char *to, colorselector_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_ctxpopup_prop(char *to, ctxpopup_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_datetime_prop(char *to, datetime_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_entry_prop(char *to, entry_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_flip_prop(char *to, flip_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_gengrid_prop(char *to, gengrid_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_genlist_prop(char *to, genlist_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_glview_prop(char *to, glview_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_icon_prop(char *to, icon_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_elm_image_prop(char *to, elm_image_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_index_prop(char *to, index_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_label_prop(char *to, label_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_list_prop(char *to, list_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_map_prop(char *to, map_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_notify_prop(char *to, notify_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_panel_prop(char *to, panel_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_photo_prop(char *to, photo_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_photocam_prop(char *to, photocam_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_popup_prop(char *to, popup_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_progressbar_prop(char *to, progressbar_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_radio_prop(char *to, radio_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_segmencontrol_prop(char *to, segmencontrol_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_slider_prop(char *to, slider_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_spinner_prop(char *to, spinner_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_toolbar_prop(char *to, toolbar_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_tooltip_prop(char *to, tooltip_prop_t *prop)
{
	if (!prop)
		return to;
...
static char *pack_win_prop(char *to, win_prop_t *prop)
{
	if (!prop)
		return to;
...
char *pack_ui_obj_prop(char *to, Evas_Object *obj)
{
	...
	to = pack_ui_obj_evas_prop(to, &obj_prop);
	...
	if (category == UI_ELM) {
		...
		to = pack_ui_obj_elm_prop(to, &elm_prop);
		...
		to = pack_ui_obj_edje_prop(to, &edje_prop);
	}
	...
	switch (code) {
		...
		case UI_EVAS_IMAGE:
			...
			to = pack_image_prop(to, &image_prop);
			break;
		case UI_EVAS_LINE:
			...
			to = pack_line_prop(to, &line_prop);
			break;
		case UI_EVAS_TEXT:
			evas_object_text_font_get(obj, text_prop.fonts, &(text_prop.size));
			...
			to = pack_text_prop(to, &text_prop);
			break;
		case UI_EVAS_TEXTBLOCK:
			...
			to = pack_textblock_prop(to, &textblock_prop);
			break;
		case UI_EVAS_TABLE:
			...
			to = pack_table_prop(to, &table_prop);
			break;
		case UI_EVAS_BOX:
			...
			to = pack_box_prop(to, &box_prop);
			break;
		case UI_EVAS_GRID:
			grid_prop.mirrored = evas_object_grid_mirrored_get(obj);
//			TODO:
//			evas_obj_grid_pack_get(obj, &(grid_prop.pack[0]),
//						    &(grid_prop.pack[1]),
//						    &(grid_prop.pack[2]),
//						    &(grid_prop.pack[3]));
			grid_prop.pack[0] = 0;
			...
			to = pack_grid_prop(to, &grid_prop);
			break;
		case UI_EVAS_TEXTGRID:
			...
			to = pack_textgrid_prop(to, &textgrid_prop);
			break;
		...
		case UI_ELM_BUTTON:
			...
			to = pack_button_prop(to, &button_prop);
			break;
		case UI_ELM_CHECK:
			check_prop.state = elm_check_state_get(obj);

			to = pack_check_prop(to, &check_prop);
			break;
		case UI_ELM_COLORSELECTOR:
			...
			to = pack_colorselector_prop(to, &colorselector_prop);
			break;
		case UI_ELM_CTXPOPUP:
			ctxpopup_prop.horizontal = elm_ctxpopup_horizontal_get(obj);

			to = pack_ctxpopup_prop(to, &ctxpopup_prop);
			break;
		case UI_ELM_DATETIME:
			...
			to = pack_datetime_prop(to, &datetime_prop);
			break;
		case UI_ELM_ENTRY:
		...
		case UI_ELM_GENGRID:
			...
			to = pack_gengrid_prop(to, &gengrid_prop);
			break;
		case UI_ELM_GENLIST:
			...
			to = pack_genlist_prop(to, &genlist_prop);
			break;
		case UI_ELM_GLVIEW:
		...
		case UI_ELM_IMAGE:
			...
			to = pack_elm_image_prop(to, &elm_image_prop);
			break;
		case UI_ELM_INDEX:
			...
			to = pack_index_prop(to, &index_prop);
			break;
		case UI_ELM_LABEL:
			...
			to = pack_label_prop(to, &label_prop);
			break;
		case UI_ELM_LIST:
			...
			to = pack_list_prop(to, &list_prop);
			break;
		case UI_ELM_MAP:
		...
		case UI_ELM_NOTIFY:
			...
			to = pack_notify_prop(to, &notify_prop);
			break;
		case UI_ELM_PANEL:
			...
			to = pack_panel_prop(to, &panel_prop);
			break;
		case UI_ELM_PHOTO:
			...
			to = pack_photo_prop(to, &photo_prop);
			break;
		case UI_ELM_PHOTOCAM:
			...
			to = pack_photocam_prop(to, &photocam_prop);
			break;
		case UI_ELM_POPUP:
			...
			to = pack_popup_prop(to, &popup_prop);
			break;
		...
		case UI_ELM_SLIDER:
			...
			to = pack_slider_prop(to, &slider_prop);
			break;
		case UI_ELM_SPINNER:
			...
			to = pack_spinner_prop(to, &spinner_prop);
			break;
		case UI_ELM_TOOLBAR:
