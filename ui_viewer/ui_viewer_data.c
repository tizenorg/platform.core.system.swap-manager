...
static Eina_List *_get_obj_info(Eina_List *ui_obj_info_list, Evas_Object *obj)
{
	...
	info->id = (uint64_t)(uintptr_t) obj;
	...
	info->parent_id = (uint64_t)(uintptr_t)evas_object_smart_parent_get(obj);
