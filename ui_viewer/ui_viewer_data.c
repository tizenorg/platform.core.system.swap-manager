...
static Eina_List *_print_obj_info(Eina_List *ui_obj_info_list, Evas_Object *obj);
...
static Eina_List *_print_obj_info(Eina_List *ui_obj_info_list, Evas_Object *obj)
{
	...
	EINA_LIST_FREE(children, child) {
		ui_obj_info_list = _print_obj_info(ui_obj_info_list, child);
	}
...
{
	Eina_List *ecore_evas_list, *ui_obj_info_list;
	Ecore_Evas *ee;
...
Eina_List *ui_viewer_get_all_objs(void)
{
	...
	info = _get_all_objs_in_rect(SHRT_MIN, SHRT_MIN, USHRT_MAX, USHRT_MAX,
				    EINA_TRUE, EINA_TRUE);
