...
// ========================= print log =====================================
#define PRINTMSG(...)	ui_print_log_fmt(MSG_MSG, __FUNCTION__, __LINE__, __VA_ARGS__)
#define PRINTWRN(...)	ui_print_log_fmt(MSG_WARNING, __FUNCTION__, __LINE__, __VA_ARGS__)
#define PRINTERR(...)	ui_print_log_fmt(MSG_ERROR, __FUNCTION__, __LINE__, __VA_ARGS__)
...
bool ui_print_log_str(int msgType, char *st);
